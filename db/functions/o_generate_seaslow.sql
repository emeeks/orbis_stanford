CREATE OR REPLACE FUNCTION o_generate_seaslow(month integer, source character varying, target character varying, note character varying)
  RETURNS void AS
$BODY$INSERT INTO o_slowsea (source, target, slabel, tlabel, total, the_geom, month, note)
...
LEFT JOIN o_slow_ave AS ship ON ship.gid = o_ref.rose_id
