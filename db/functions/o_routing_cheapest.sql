...
CREATE OR REPLACE FUNCTION o_routing_cheapest(IN source integer, IN target integer, IN month integer, IN vehicle character varying, IN mode character varying)
